...
# 0.2.4
#   4:48pm until -:--pm - 13-04-22 - The fact that we're getting somewhere makes me cry of happiness.
...
def runLine(lineScript, tempObject, attachedVariables):
    ...
    if lineScript.startswith("run"):
        ...
        runScript(open(f"{lineScript.split(' ')[1]}.str", "r").readlines(), GlobalTD, GlobalVariables)
    # Raising Issues
